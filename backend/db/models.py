...
class Subscription(Base):
    ...
    status: Mapped[SubscriptionStatus] = mapped_column(Enum(SubscriptionStatus), default=SubscriptionStatus.INACTIVE, nullable=False)
...
class Epic(Base):
    ...
    current_stage: Mapped[EpicStage] = mapped_column(Enum(EpicStage), default=EpicStage.PROBLEM_CAPTURE, nullable=False)
...
class EpicTranscriptEvent(Base):
    ...
    stage: Mapped[EpicStage] = mapped_column(Enum(EpicStage), nullable=False)
...
class EpicDecision(Base):
    ...
    from_stage: Mapped[EpicStage] = mapped_column(Enum(EpicStage), nullable=False)
    to_stage: Mapped[Optional[EpicStage]] = mapped_column(Enum(EpicStage), nullable=True)
...
class PaymentTransaction(Base):
    ...
    payment_status: Mapped[PaymentStatus] = mapped_column(Enum(PaymentStatus), default=PaymentStatus.INITIATED, nullable=False)
