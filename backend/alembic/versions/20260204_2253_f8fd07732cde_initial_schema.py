...
Revision ID: f8fd07732cde
Revises: 
Create Date: 2026-02-04 22:53:13.801844
...
def _downgrade_schema() -> None:
    ...
    NOTE: This migration was generated with upgrade/downgrade inverted.
    The original `upgrade()` contained drop_* operations.
    """
...
def upgrade() -> None:
    ...
    This creates the initial schema on a fresh database.
    (The original autogenerated migration had upgrade/downgrade inverted.)
    """
    # ### commands auto generated by Alembic - please adjust! ###
...
def downgrade() -> None:
    """Downgrade schema (drops all objects created in upgrade)."""
    _downgrade_schema()
