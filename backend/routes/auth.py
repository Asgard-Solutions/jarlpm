...
from services.rate_limit import limiter, RATE_LIMITS, get_ip_only
...
async def signup(
    ...
    base_url = str(request.headers.get("origin", "https://aipm-platform-1.preview.emergentagent.com"))
    try:
