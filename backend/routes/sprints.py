...
from db.models import Epic, DeliveryContext
...
Generate WIP optimization suggestions."""
    ...
    try:
        ...
        return WipSuggestions(
            finish_first=result.get("finish_first", []),
            consider_pausing=result.get("consider_pausing", []),
