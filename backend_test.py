...
class JarlPMAPITester:
    def __init__(self, base_url: str = "https://jarlpm-convtool.preview.emergentagent.com"):
    ...
    def test_subscription_endpoints(self):
        ...
        checkout_data = {"origin_url": "https://jarlpm-convtool.preview.emergentagent.com"}
