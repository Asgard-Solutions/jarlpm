...
class JarlPMAPITester:
    def __init__(self, base_url: str = "https://aipm-platform-1.preview.emergentagent.com"):
    ...
    def test_subscription_endpoints(self):
        ...
        checkout_data = {"origin_url": "https://aipm-platform-1.preview.emergentagent.com"}
